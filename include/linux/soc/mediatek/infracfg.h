...
#define MT6768_TOP_AXI_PROT_EN_MD			BIT(7)
#define MT6768_TOP_AXI_PROT_EN_MD_2ND			(BIT(3) | BIT(4))
#define MT6768_TOP_AXI_PROT_EN_CONN			(BIT(13) | BIT(18))
#define MT6768_TOP_AXI_PROT_EN_CONN_2ND		(BIT(14) | BIT(16)) // TODO: remove BIT(16)?; step 2
#define MT6768_TOP_AXI_PROT_EN_DPY      (BIT(0) | BIT(5) | BIT(23) | BIT(26))
#define MT6768_TOP_AXI_PROT_EN_MFG			BIT(25)
#define MT6789_TOP_AXI_PROT_EN_MFG_2ND	(BIT(21) | BIT(22)) // step 2
#define MT6768_TOP_AXI_PROT_EN_CAM			(BIT(19) | BIT(21))
#define MT6768_TOP_AXI_PROT_EN_CAM_2ND		(BIT(20) | BIT(3)) // TODO: remove BIT(3)?; step 2
#define MT6768_TOP_AXI_PROT_EN_1_DISP			(BIT(19) | BIT(20))
#define MT6768_TOP_AXI_PROT_EN_1_MFG			GENMASK(21, 19)
#define MT6768_TOP_AXI_PROT_EN_MM_ISP			BIT(20)
#define MT6768_TOP_AXI_PROT_EN_MM_ISP_2ND		BIT(2)
#define MT6768_TOP_AXI_PROT_EN_MM_CAM			(BIT(4) | BIT(5) | \
							 BIT(9) | BIT(13))
#define MT6768_TOP_AXI_PROT_EN_MM_VPU_TOP		(GENMASK(9, 6) | \
							 BIT(12))
#define MT6768_TOP_AXI_PROT_EN_MM_VPU_TOP_2ND		(BIT(10) | BIT(11))
#define MT6768_TOP_AXI_PROT_EN_MM_CAM_2ND		BIT(11)
#define MT6768_TOP_AXI_PROT_EN_MCU_VPU_CORE0_2ND	(BIT(0) | BIT(2) | \
							 BIT(4))
#define MT6768_TOP_AXI_PROT_EN_MCU_VPU_CORE1_2ND	(BIT(1) | BIT(3) | \
							 BIT(5))
#define MT6768_TOP_AXI_PROT_EN_MCU_VPU_CORE0		BIT(6)
#define MT6768_TOP_AXI_PROT_EN_MCU_VPU_CORE1		BIT(7)

#define MT6768_SMI_COMMON_CLAMP_EN			0x3c0
#define MT6768_SMI_COMMON_CLAMP_EN_SET			0x3c4
#define MT6768_SMI_COMMON_CLAMP_EN_CLR			0x3c8

#define MT6768_SMI_COMMON_SMI_CLAMP_DISP		GENMASK(7, 0)
#define MT6768_SMI_COMMON_SMI_CLAMP_VENC		BIT(1)
#define MT6768_SMI_COMMON_SMI_CLAMP_ISP			BIT(2)
#define MT6768_SMI_COMMON_SMI_CLAMP_CAM			(BIT(3) | BIT(4))
#define MT6768_SMI_COMMON_SMI_CLAMP_VPU_TOP		(BIT(5) | BIT(6))
#define MT6768_SMI_COMMON_SMI_CLAMP_VDEC		BIT(7)
